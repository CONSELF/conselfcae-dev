...
)
{
    ...
    if (fieldHeader.headerOk())
    {
        ...
        writeDivField<surfaceScalarField,volScalarField>(fieldHeader, mesh, processed);
        writeDivField<volVectorField,volScalarField>(fieldHeader, mesh, processed);
        writeDivField<volTensorField,volVectorField>(fieldHeader, mesh, processed);
